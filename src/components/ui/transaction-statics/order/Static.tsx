    ...
    <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
      <div className="w-full flex items-start space-x-4 rounded-lg border border-primary/20 p-3 bg-primary/5 hover:bg-primary/10 transition-colors">
        ...
        <div className="min-w-0 flex-1 overflow-hidden">
          ...
          <p className="text-lg md:text-xl font-bold truncate text-primary">{formatCurrency(data.total.totalRevenue, 'vi-VN')}</p>
        </div>
      </div>
      ...
      <div className="w-full flex items-start space-x-4 rounded-lg border border-green-500/20 p-3 bg-green-500/5 hover:bg-green-500/10 transition-colors">
        ...
        <div className="min-w-0 flex-1 overflow-hidden">
          ...
          <p className="text-lg md:text-xl font-bold truncate text-green-500">{formatCurrency(data.total.totalPlatformVoucherDiscount, 'vi-VN')}</p>
        </div>
      </div>
      ...
      <div className="w-full flex items-start space-x-4 rounded-lg border border-yellow-500/20 p-3 bg-yellow-500/5 hover:bg-yellow-500/10 transition-colors">
        ...
        <div className="min-w-0 flex-1 overflow-hidden">
          ...
          <p className="text-lg md:text-xl font-bold truncate text-yellow-500">{formatCurrency(data.total.totalShopVoucherDiscount, 'vi-VN')}</p>
        </div>
      </div>
    </div>
  );
