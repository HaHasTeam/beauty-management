...
const Static = ({ data, mode = 'full' }: OrderStaticProps) => {
  ...
  const miniDescriptionNode = (
    <div className='w-full flex flex-row flex-wrap gap-3 pt-2'> {/* Use flex-row and wrap */} 
      {/* Actual Revenue Card (compact) */}
      <div className='flex items-center space-x-2 rounded-lg border border-[hsl(var(--chart-blue))] p-2 bg-[hsla(var(--chart-blue)/0.05)] hover:bg-[hsla(var(--chart-blue)/0.1)] transition-colors flex-1 min-w-[150px]'> {/* Added flex-1 and min-width */} 
      ...
      <div className='flex items-center space-x-2 rounded-lg border border-orange-500/20 p-2 bg-orange-500/5 hover:bg-orange-500/10 transition-colors flex-1 min-w-[150px]'> {/* Added flex-1 and min-width */} 
