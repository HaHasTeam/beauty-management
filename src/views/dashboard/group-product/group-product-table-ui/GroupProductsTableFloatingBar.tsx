...
interface GroupProductsTableFloatingBarProps {
  table: Table<TGroupProduct>
}

export function GroupProductsTableFloatingBar({ table }: GroupProductsTableFloatingBarProps) {
            ...
            <div className='flex items-center gap-1.5'>
              <Select>
                ...
                <SelectContent align='center'>
                  <SelectGroup>
                    {Object.keys(GroupProductStatusEnum).map((status) => {
