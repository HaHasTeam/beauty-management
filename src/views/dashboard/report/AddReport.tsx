import ConsultantServiceDetails from './ReportDetails'
import ConsultantServiceSummary from './ReportSummary'

const AddConsultantService = () => {
  return (
...
export default AddConsultantService
