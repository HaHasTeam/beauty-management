...
interface FlashSalesTableFloatingBarProps {
  table: Table<TFlashSale>
}

export function FlashSalesTableFloatingBar({ table }: FlashSalesTableFloatingBarProps) {
            ...
            <div className='flex items-center gap-1.5'>
              <Select>
                ...
                <SelectContent align='center'>
                  <SelectGroup>
                    {Object.keys(FlashSaleStatusEnum).map((status) => {
